      ...
      <div className="row justify-content-center py-5">
        <div className="col-lg-8">
          <div className="bg-light p-5 shadow-lg rounded content-div">
            <h4 className="mb-4 fw-bold text-dark shadow-lg fs-3 text-decoration-underline">
              Online Registration Form
            </h4>
            <p className="mb-4 text-dark">Register online today and take the first step towards success!</p>
